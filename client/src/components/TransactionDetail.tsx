    ...
    <div className="p-4 max-w-md mx-auto">
      ...
      {isEditing ? (
        ...
        <div>
          ...
          <p>
            <strong>タイプ:</strong> {transaction.type}
          </p>
          <p>
            <strong>カテゴリ:</strong> {transaction.category}
          </p>
          <p>
            <strong>金額:</strong> {transaction.amount.toLocaleString()} 円
          </p>
          {transaction.memo && (
            <p>
              <strong>メモ:</strong> {transaction.memo}
            </p>
          )}
